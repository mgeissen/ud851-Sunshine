...
public class DetailActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final int ID_DETAIL_LOADER = 14;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvDescription = (TextView) findViewById(R.id.tv_weather);
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        tvPressure.setText(getString(R.string.format_pressure, pressure));

        mForecastSummary = String.format("%s - %s - %s/%s",
                dateText, description, highString, minTempString);
    }
